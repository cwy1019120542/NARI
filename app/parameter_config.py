...
send_config_parameter = {
    "POST": [('subject', str, False, 50), ('content', str, False, 60000), ('split_type', int, False, 11), ('sheet', str, False, 10000),
...
receive_config_parameter = {
    "POST": [('subject', str, False, 50), ('sheet_info', str, False, 10000), ('is_timing', bool, False, 10),
                         ('start_timestamp', int, True, 11), ('ip', str, False, 50), ('port', int, False, 11), ('is_remind', bool, False, 10), ('remind_subject', str, False, 50),
                            ('remind_ip', str, False, 50), ('remind_port', int, False, 11), ('remind_content', str, False, 60000), ('read_start_timestamp', int, False, 11), ('read_end_timestamp', int, False, 11), ("template_excel_uuid_name", str, True, 100), ("template_excel_field", str, True, 10000)],
    "GET": [('id', int, False, 11), ('offset', int, False, 11), ('limit', int, False, 11)],
    "fuzzy_field": []
}
remind_parameter = {
