...
nohup gunicorn /home/cwy/PycharmProjects/NARIProjects/NARI/manage:app -c /home/cwy/PycharmProjects/NARIProjects/NARI/gunicorn_config.py >> /var/log/flask_nari.log &